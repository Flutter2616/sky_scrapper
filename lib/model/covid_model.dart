...
List<Covidmodel> temperaturesFromJson(String str) => List<Covidmodel>.from(json.decode(str).map((x) => Covidmodel.fromJson(x)));

String temperaturesToJson(List<Covidmodel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
